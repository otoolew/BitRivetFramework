...
{ 
    ...
    public class Poolable : MonoBehaviour
    {
        ...
        public static void TryPool(GameObject gameObject)
        {
            ...
            if (poolable != null && poolable.pool != null && PoolManager.IsInitialized)
            {
                poolable.Repool();
            }
            else
        ...
        public static T TryGetPoolable<T>(GameObject prefab) where T : Component
        {
            ...
            T instance = poolable != null && PoolManager.IsInitialized ?
        ...
        {
            var poolable = prefab.GetComponent<Poolable>();
            GameObject instance = poolable != null && PoolManager.IsInitialized ?
